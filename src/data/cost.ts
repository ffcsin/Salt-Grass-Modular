...
export const COST_TIERS = [
  ...
  { model: '1-Bedroom Container Home', size: '640 SF', price: '$105,000' },
  { model: '2-Bedroom Container Home', size: '960 SF', price: '$155,000' },
  { model: 'Tube Steel + Fiberglass Pool', size: 'varies', price: '$12,000–$24,000' },
  { model: 'Welded Steel + Epoxy Pool', size: 'varies', price: '$18,000–$36,000' },
] as const;

// All-in pricing always includes fabrication, delivery, and installation.
export const PRICE_INCLUDES =
  'All Saltgrass prices are all-in: fabrication, delivery, and initial systems startup. Delivery distance from our Wagner, Oklahoma facility is the main location-based variable.';
...
export const SEED_COST_CITIES: CostCity[] = [
  {
    ...
    note: 'Oklahoma City is near our Wagner, OK fabrication facility, keeping delivery logistics simple and costs low.',
    faqs: [
  ...
  },
  {
    ...
    note: 'Dallas–Fort Worth delivery costs reflect the distance from our Wagner, OK facility; we provide an all-in quote for your exact site.',
    faqs: [
      ...
      { q: 'Are modular pools available in Dallas?', a: 'Yes — Tube Steel + Fiberglass pools run $12K–$24K and Welded Steel + Epoxy pools $18K–$36K, including installation.' },
    ],
  },
];
