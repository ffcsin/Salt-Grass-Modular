...
export const SEED_LOCATIONS: LocationData[] = [
  {
    ...
    intro:
      "Oklahoma is our home state — Saltgrass Modular fabricates in Wagner, OK, and Oklahoma homeowners, developers, and agencies are who we build for first. From tornado-resistant container homes to modular pools and rapid-deployment housing, we deliver throughout the state with shorter lead times than out-of-state builders.",
    faqs: [
      { q: 'Does Saltgrass build container homes in Oklahoma?', a: 'Yes. Oklahoma is our home state — we fabricate in Wagner, OK and deliver custom container homes, traditional modular builds, and modular pools statewide, including Oklahoma City, Tulsa, Norman, and rural areas.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'Does Saltgrass deliver modular homes to Texas?', a: 'Yes. Texas is within our core regional delivery radius from our Wagner, OK facility. We serve the major metros — Houston, Dallas–Fort Worth, San Antonio, Austin — as well as rural Texas.' },
  ...
  // ----- metros (seed examples) -----
  {
    ...
    intro:
      'Oklahoma City is in our backyard. From our Wagner, OK facility we deliver custom container homes, modular pools, and rapid-deployment housing throughout the OKC metro — Edmond, Norman, Moore, and Midwest City — with the shortest lead times we offer anywhere.',
    faqs: [
      { q: 'Does Saltgrass build container homes in Oklahoma City?', a: 'Yes. OKC is one of our closest markets to our Wagner facility, so lead times and delivery costs are among the lowest we offer. We build container homes, modular pools, and traditional modular throughout the metro.' },
  ...
  },
  {
    ...
    intro:
      "Tulsa is right next door to our Wagner facility — one of our closest and fastest markets. Saltgrass delivers custom container homes, modular pools, and rapid-deployment housing across the Tulsa metro, including Broken Arrow, Owasso, and Bixby.",
    faqs: [
      { q: 'Does Saltgrass serve the Tulsa area?', a: 'Yes — Tulsa is one of our nearest markets to the Wagner, OK facility. We deliver container homes, modular pools, and traditional modular builds throughout the Tulsa metro with short lead times.' },
